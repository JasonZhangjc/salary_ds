...
def get_jobs(keyword, num_jobs, verbose, path, sleep_time):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        try:
            driver.find_element("class name", "selected").click()
        ...
        try:
            # driver.find_element("class name", "ModalStyle__xBtn___29PT9").click()  #clicking to the X.
